...
echo "Input for generating the sample sequences in a FASTA file."
...
echo "Collecting the indices for the SNPs."
...
echo "Reading the SNP data and modifying the reference sequence per sample."
...
echo "Sequences per sample defined and saved."
